...
var App = function () {
    ...
    return {
        ...
        blockUI: function (el, centerY) {
            ...
            el.block({
                message: '<img src="/hr/img/ajax-loading.gif">',
        ...
        releaseKRM: function (el) {
            var el = jQuery(el);
            el.block({
                message: 'Oops! KRM Updating...<br >Hệ thống đang nâng cấp, vui lòng trở lại sau!' +
                    '<br>Espresso Team!<br><img src="/img/updating.gif">',
                centerY: true,
                css: {
                    top: '10%',
                    border: 'none',
